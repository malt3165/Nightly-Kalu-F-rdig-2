...
import { ArrowLeft, Search, MapPin, Calendar, Users, Star, Filter, Clock } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Find fest</Text>
        ...
        <View style={styles.searchSection}>
          <View style={styles.searchContainer}>
            ...
            <TextInput
              ...
              placeholder="Søg efter events, klubber eller steder..."
          ...
          <View style={styles.eventsSection}>
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>
                {filteredEvents.length} events fundet
              </Text>
            </View>
            ...
            {filteredEvents.length === 0 ? (
              <View style={styles.emptyState}>
                ...
                <Text style={styles.emptyStateTitle}>Ingen events fundet</Text>
                <Text style={styles.emptyStateText}>
                  Prøv at ændre dine søgekriterier eller vælg en anden kategori
                </Text>
              </View>
            ) : (
