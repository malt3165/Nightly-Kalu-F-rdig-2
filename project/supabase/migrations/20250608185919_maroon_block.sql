/*
  ...
  1. New Tables
    ...
    - `groups` - Brugergrupper og fællesskaber
    - `group_members` - Medlemskab af grupper
    - `check_ins` - Check-ins på klubber og barer
    
  2. Security
    - Enable RLS på alle tabeller
    - Policies for sikker adgang til egne data
    - Automatisk timestamps og triggers
    
  3. Performance
    - Indexes på ofte brugte kolonner
    - Foreign key constraints for data integritet
*/
